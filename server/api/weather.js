  ...
  /**
    ...
    */
    ...
    /**
      ...
      *
      * @param {number} zipCode The zipcode used as unique identifier to find the document from MongoDb
    ...
    /**
      ...
      *
      * @param{{zip: number}} filter The filter is the zipcode used as unique identifier to find document from mongodb
      * @return {JSON} The data response from mongodb
      */
